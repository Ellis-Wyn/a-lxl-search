...
**操作维护文档** ⭐ 2026-03-07新增:
- `code/docs/OPERATIONS_MANUAL.md` - **完整操作维护手册**
  - 数据控制位置映射（什么文件控制什么数据）
  - 配置文件完整说明（.env 所有参数）
  - 爬虫系统使用指南（启用/禁用/选择性爬取）
  - 常用操作命令和故障排查
- `code/docs/QUICK_REFERENCE.md` - **快速参考卡**
  - 快速启动命令
  - 关键文件位置
  - 常用配置修改
- `code/docs/ENV_TEMPLATE.md` - **配置文件模板**
  - .env 完整模板（带详细注释）
  - 所有参数说明和推荐值
- `code/docs/CRAWLER_GUIDE.md` - **爬虫系统使用指南**
  - 爬虫架构说明
  - 12个药企爬虫使用方法
  - 调度器配置和监控
...
2. **code/docs/OPERATIONS_MANUAL.md** - 操作维护手册（⭐推荐）
3. **code/docs/QUICK_REFERENCE.md** - 快速参考卡
4. **code/docs/CRAWLER_GUIDE.md** - 爬虫系统指南
5. **START_HERE.md** - 3分钟快速入门
6. **QUICKSTART.md** - 完整使用指南
7. **SWAGGER_TEST_GUIDE.md** - API测试指南
...
- ✅ **创建完整操作维护文档** - 4个文档文件
  - `OPERATIONS_MANUAL.md` - 主操作手册（数据控制位置、配置说明、爬虫使用）
  - `QUICK_REFERENCE.md` - 快速参考卡（常用命令速查）
  - `ENV_TEMPLATE.md` - 配置文件模板（带详细注释）
  - `CRAWLER_GUIDE.md` - 爬虫系统完整指南（12个药企爬虫使用方法）
- ✅ **数据控制映射完整** - 什么文件控制什么数据的完整清单
- ✅ **爬虫操作指南完整** - 启用/禁用、选择性爬取、调度配置的详细说明
